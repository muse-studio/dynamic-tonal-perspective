...
\title{\input{credit/author-title}}
...
\begin{abstract}
本デモでは，歌唱中に演奏者が内部で保持する「主観的調性感」の変化を体験する一人合唱インタフェースを紹介する．本研究は，楽曲に固定的な調名を割り当てるのではなく，Subjective Tonicを基準とするRelative Tonal Frame（RTF）を主観的調性感の内部表現として扱う．参加者は任意の音高から旋律を歌唱し，RTFに基づいてリアルタイムに生成される合唱とのインタラクションを通して，動的な調性感と音楽体験について議論する．
\end{abstract}
...
% 本文．
% ==========================================
\input{sigmus147-body}  % 本文は muselab-sample.tex に書く
