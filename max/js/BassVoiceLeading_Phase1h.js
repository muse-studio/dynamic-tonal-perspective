...
function evaluate(degree) {
    ...
    // Phase 1h standalone state convenience:
    // remember selected pitch so a simple test can run without Part State store.
    // In integrated system this will be replaced/overridden by Part State.previousPitch.
