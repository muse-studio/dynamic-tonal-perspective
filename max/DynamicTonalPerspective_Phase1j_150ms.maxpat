{
  "patcher": {
    ...
    "boxes": [
      ...
      {
        "box": {
          "id": "obj-phase1j-comment",
          "maxclass": "comment",
          "text": "Phase 1j: voiceActive 0=close immediately / 1=open after 150 ms",
          "patching_rect": [
            40.0,
            40.0,
            390.0,
      ...
      },
      {
        "box": {
          "id": "obj-phase1j-note",
          "maxclass": "comment",
          "text": "Use pitchInputGate as the control for the gate immediately before PitchInterpreter_Phase1.",
          "patching_rect": [
            40.0,
            255.0,
            500.0,
